...
I have included below a random script that I occasionally use to convert video files. The code is read directly from a file by using the \textit{listings} package.
\lstinputlisting[language=bash]{code/fconvert}

\subsection{A citation}
\lipsum[1]\cite{contributors_lorem_2021}
